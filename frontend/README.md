...
## Something Missing?
To run the widget, run the frontend app and the in the console copy the following:
```
var prevDiv = document.getElementById('app');
if (prevDiv) prevDiv.outerHTML = "";

var div = document.createElement('div');
div.id = 'app';
div.setAttribute("style", "position: fixed; bottom: 40px; right: 40px; z-index: 100000000");
document.body.append(div);

var script = document.createElement('script');
script.setAttribute('src', 'http://localhost:4000/index.js');
